 ...
 * equations
 */
class ADBoundaryFlux3EqnGhostDensityPressure : public ADBoundaryFlux3EqnGhostBase
{
public:
  ADBoundaryFlux3EqnGhostDensityPressure(const InputParameters & parameters);
